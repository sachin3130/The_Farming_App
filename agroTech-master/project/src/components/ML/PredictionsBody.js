...
=======
          <button className={classes.button}><Link to="/fertilizer">get Started</Link></button>
...
=======
          <button className={classes.button}><Link to="/crop_recommendation">get Started</Link></button>
>>>>>>> 92337f96e7f000497b5ac190f20e67ccf2b92974
      </div>
      </div>
    </div>
